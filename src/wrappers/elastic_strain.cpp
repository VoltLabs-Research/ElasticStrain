...
ElasticStrainWrapper::ElasticStrainWrapper()
...
void ElasticStrainWrapper::setInputCrystalStructure(LatticeStructureType structure){
    _inputCrystalStructure = structure;
}

void ElasticStrainWrapper::setIdentificationMode(StructureAnalysis::Mode mode){
    _identificationMode = mode;
}

void ElasticStrainWrapper::setRMSD(float rmsd){
    _rmsd = rmsd;
}

void ElasticStrainWrapper::setParameters(
...
std::shared_ptr<ParticleProperty> ElasticStrainWrapper::createPositionProperty(const LammpsParser::Frame &frame){
...
json ElasticStrainWrapper::compute(const LammpsParser::Frame &frame, const std::string &outputFilename){
